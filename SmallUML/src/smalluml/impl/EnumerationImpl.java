 ...
 * @generated
 */
public class EnumerationImpl extends SuperTypeImpl implements Enumeration {
	/**
	 ...
	 * @ordered
	 */
	protected EList<String> enumeration;
	 ...
	 * @generated
	 */
	public EList<String> getEnumeration() {
		if (enumeration == null) {
			enumeration = new EDataTypeUniqueEList<String>(String.class, this, SmallumlPackage.ENUMERATION__ENUMERATION);
		}
		return enumeration;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SmallumlPackage.ENUMERATION__ENUMERATION:
				...
				getEnumeration().addAll((Collection<? extends String>)newValue);
				return;
		}
