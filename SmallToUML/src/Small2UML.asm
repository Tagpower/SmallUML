...
<asm version="1.0" name="0">
	...
	<operation name="58">
		...
		<linenumbertable>
			...
			<lne id="68" begin="17" end="17"/>
			<lne id="69" begin="17" end="18"/>
			<lne id="70" begin="15" end="20"/>
			<lne id="57" begin="8" end="21"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="3" name="53" begin="7" end="21"/>
			<lve slot="2" name="51" begin="3" end="21"/>
